...
class Profil extends Component {
    ...
    public function mount() {
        ...
        //'/users/'.fun::getCookie('mcr_x_aswq_2').'/photos/foto_profil.png'; #Storage::get('/app/private/users/'.fun::getCookie('mcr_x_aswq_2').'/photos/foto_profil.png'); //Cache::get('page_profil_pathfoto');

        if(Session::has('pesan')) {
            Cache::put('page_profil_dataprofil-'.fun::getCookie('mcr_x_aswq_1'), $this->service->getProfil(fun::getCookie('mcr_x_aswq_1')), 1*24*60*60);
            $this->data = Cache::get('page_profil_dataprofil-'.fun::getCookie('mcr_x_aswq_1'));
        }

        if(Cache::has('page_profil_dataprofil-'.fun::getCookie('mcr_x_aswq_1'))) $this->data = Cache::get('page_profil_dataprofil-'.fun::getCookie('mcr_x_aswq_1'));
        else {
            Cache::put('page_profil_dataprofil-'.fun::getCookie('mcr_x_aswq_1'), $this->service->getProfil(fun::getCookie('mcr_x_aswq_1')), 1*24*60*60);
            $this->data = Cache::get('page_profil_dataprofil-'.fun::getCookie('mcr_x_aswq_1'));
        }

        // if(!Cache::has('page_profil_pathfoto')) {
