...
<div class="flex flex-col static">
    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form action="/process/user/update" method="PUT">
                {{-- ?Username --}}
                <div>
                    <span class="text-sm text-black font-bold">{{ __('Username') }}</span>
                    <x-text-input wire:model="username" :value="'User 1'" id="user" class="block mt-1 w-full" type="text" name="username" required autofocus autocomplete="username" disabled />
                </div>

                {{-- ?Email --}}
                <div>
                    <span class="text-sm text-black font-bold">{{ __('Email') }}</span>
                    <x-text-input wire:model="email" :value="'user@user.com'" id="email" class="block mt-1 w-full" type="email" name="email" required autofocus autocomplete="email" disabled />
                </div>

                {{-- ?Nama --}}
                <div>
                    <span class="text-sm text-black font-bold">{{ __('Nama') }}</span>
                    <x-text-input wire:model="nama" id="user" class="block mt-1 w-full" type="text" name="nama" required autofocus autocomplete="nama" />
                </div>
                ...
                <div class="flex flex-row gap-2">
                    <div class="basis-1/2 flex-1">
                        ...
                        <x-text-input wire:model="tempat_lahir" id="tempat_lahir" class="block mt-1 w-full" type="text" name="tempat_lahir" required autofocus autocomplete="tempat lahir" />
                    </div>
                    <div class="basis-1/2 flex-1">
                        <span class="text-sm text-black font-bold">{{ __('Tanggal Lahir') }}</span>
                        <x-text-input wire:model="tgl_lahir" id="tgl_lahir" class="block mt-1 w-full" type="date" name="tgl_lahir" required autofocus />
                    </div>
                </div>
                ...
                <div class="flex flex-row gap-2">
                    <div class="basis-1/4 flex-1">
                        ...
                        <select wire:model="id_umkm" id="id_umkm" name="id_umkm" class="block mt-1 w-full rounded">
                    ...
                    <div class="basis-1/4 flex-1">
                        ...
                        <x-text-input wire:model="jabatan" id="jabatan" class="block mt-1 w-full" type="text" name="jabatan" required autofocus autocomplete="jabatan" />
                    </div>
                    <div class="basis-1/4 flex-1">
                        <span class="text-sm text-black font-bold">{{ __('Status') }}</span>
                        <select wire:model="status" id="status" name="id_umkm" class="block mt-1 w-full rounded">
                ...
                <div>
                    ...
                    <x-text-input wire:model="tlp" id="tlp" class="block mt-1 w-full" type="text" name="tlp" required autofocus autocomplete="tlp" />
                </div>
                ...
                <div>
                    <img src="" />
                    <x-text-input wire:model="foto" id="foto" class="block mt-1 w-full" type="file" name="foto" required autofocus autocomplete="foto" />
                </div>
